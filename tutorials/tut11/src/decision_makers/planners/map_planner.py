...
class AstarDM(DecisionMaker):
    ...
    """
    def __init__(self,env : MultiTaxiEnv, single_plan = True, Taxi_index=0, domain_map=MAP2, defualt_action = 5):
        self.defualt_action = defualt_action
